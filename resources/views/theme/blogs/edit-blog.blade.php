...
@section('contant')
    @include('theme.partials.breadcrumb', ['title' => 'Edit blog'])
    <section>
                        ...
                        <div class="gmap-form bg-white">
                            ...
                            <form method="POST" action="{{ route('blog.update', ['blog' => $slug]) }}"
                                ...
                                <div class="row form-grid">
                                    ...
                                    <div class="col-12">
                                        <textarea class="form-control" name="description" rows="3" placeholder="Enter description moive">{{ $blog->description }}</textarea>
                                        @error('description')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
